...
const Feed = () => {
  ...
  if (IsLoading) {
    return (
      <div className="pt-16">
        <div className="rounded-md p-4 max-w-md w-full mx-auto my-4">
    ...
    <>
      <div className="user-feed-page w-[40%] m-auto pt-[6rem]">
        ...
        <textarea
          ...
          className={` ${isWrite ? "block" : "hidden"
        ...
        {!allPosts && !allPosts.length > 0 ? (
          ...
          <>
            {allPosts.map((item) => (
              <div key={item.id} className="user-content flex gap-2 relative overflow-hidden p-4 custom-shadow rounded-2xl mt-8">
