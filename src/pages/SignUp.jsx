...
import IMG from "../assets/login-wallpaper.png";
...
const SignUp = () => {
    ...
    if (validateForm()) {
      try {
        ...
        if (userSnapshot.size > 0) {
          // User with this email already exists, handle accordingly (e.g., show an error message)
        ...
        await addDoc(collection(db, "users"), {
          ...
          image: "", // Add the URL of the user's profile image
          posts: [],
          followers: [],
          followings: [],
        });
  ...
  return (
    <>
      <div className="login-page w-[90%] m-auto py-2">
        <div className="login grid grid-cols-2">
          <div className="login-content w-[70%] px-3 pt-12">
            <div className="btn pt-12">
              <button className="w-[10rem] border border-black h-[2.5rem] rounded-xl text-[0.8rem] font-medium">
